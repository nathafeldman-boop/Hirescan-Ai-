...
// flottante « assistant IA » en bas à droite, sur les pages qui n'ont pas
// déjà cette même barre intégrée (voir AppTabBar.tsx). Le tab "Home" pointe
// vers /decouverte (le hub central), pas vers la landing — donc pas de sens
// de la montrer SUR la landing elle-même. Masquée sur :
//  - la landing (racine) ;
