...
export const metadata: Metadata = {
  ...
  description: '15 questionnaires anonymes de développement personnel : auto-sabotage, intelligence émotionnelle, rôle familial, narcissisme, manipulation, burnout, dépression, amour et plus. Résultats instantanés, 100% gratuit, zéro compte requis.',
  keywords: ['quiz anonyme', 'questionnaire psychologique', 'test auto-sabotage', 'test intelligence émotionnelle', 'test amour', 'quiz développement personnel', 'test rôle familial', 'vrais amis quiz', 'suis-je narcissique', 'suis-je manipulé', 'burnout test', 'UrCecret'],
  openGraph: {
    title: 'Tous les quizzes | UrCecret',
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      numberOfItems: 15,
      itemListElement: [
        { '@type': 'ListItem', position: 1,  url: `${BASE}/quiz/auto-sabotage`,    name: 'Est-ce que je me sabote sans m\'en rendre compte ?' },
        { '@type': 'ListItem', position: 2,  url: `${BASE}/quiz/role-familial`,    name: 'Quel rôle j\'ai appris à jouer dans ma famille ?' },
        ...
        { '@type': 'ListItem', position: 5,  url: `${BASE}/quiz/intelligence-emotionnelle`, name: 'Quel est mon niveau d\'intelligence émotionnelle ?' },
        { '@type': 'ListItem', position: 6,  url: `${BASE}/quiz/narcissique`,      name: 'Suis-je narcissique ?' },
        { '@type': 'ListItem', position: 7,  url: `${BASE}/quiz/tourner-la-page`,  name: 'Ai-je vraiment tourné la page ?' },
        ...
        { '@type': 'ListItem', position: 12, url: `${BASE}/quiz/schema-amoureux`,  name: 'Pourquoi je tombe toujours pour le même type de personne ?' },
