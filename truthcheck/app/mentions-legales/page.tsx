  ...
  return (
    <main className="min-h-screen" style={{ background: '#f7f3ec', color: '#2b2622' }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        <h1 className="text-2xl font-black text-stone-900 mb-2">Mentions Légales</h1>
        <p className="text-stone-500 text-sm mb-10">Conformément à la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l&apos;économie numérique (LCEN)</p>

        <div className="space-y-8 text-sm text-stone-400 leading-relaxed">

          <section>
            <h2 className="text-stone-900 font-bold text-base mb-3">1. Éditeur du site</h2>
          ...
          <section>
            <h2 className="text-stone-900 font-bold text-base mb-3">2. Hébergement</h2>
            <p>Le site est hébergé par :</p>
            <p className="mt-2 font-medium text-stone-300">Vercel Inc.</p>
            <p>340 Pine Street, Suite 701</p>
            <p>San Francisco, CA 94104 — États-Unis</p>
            <p className="mt-2">Site web : <span className="text-stone-300">vercel.com</span></p>
          </section>

          <section>
            <h2 className="text-stone-900 font-bold text-base mb-3">3. Propriété intellectuelle</h2>
          ...
          <section>
            <h2 className="text-stone-900 font-bold text-base mb-3">4. Données personnelles</h2>
            <p>UrCecret est conçu pour être utilisé de manière <strong className="text-stone-900">100% anonyme</strong>. Aucun compte n&apos;est requis pour accéder aux quiz gratuits. Pour les utilisateurs qui créent un compte (nécessaire pour accéder aux résultats premium), les données collectées sont limitées à l&apos;adresse email.</p>
          ...
          <section>
            <h2 className="text-stone-900 font-bold text-base mb-3">5. Cookies</h2>
          ...
          <section>
            <h2 className="text-stone-900 font-bold text-base mb-3">6. Limitation de responsabilité</h2>
            ...
            <p className="mt-2">En cas de détresse psychologique, consultez un professionnel de santé ou appelez le <strong className="text-stone-900">3114</strong> (numéro national de prévention du suicide — gratuit, 24h/24).</p>
          </section>

          <section>
            <h2 className="text-stone-900 font-bold text-base mb-3">7. Droit applicable</h2>
