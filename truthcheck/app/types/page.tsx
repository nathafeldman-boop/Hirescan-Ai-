    ...
    <>
      ...
      <main className="min-h-screen bg-[#09090b] text-white">
        ...
        <div className="pointer-events-none fixed inset-0 overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full blur-3xl opacity-[0.1] bg-violet-600" />
          <div className="absolute bottom-1/4 right-0 w-80 h-80 rounded-full blur-3xl opacity-[0.06] bg-pink-600" />
        </div>
                  ...
                  {group.codes.map(code => {
                    ...
                    return (
                      <Link key={code} href={`/types/${code.toLowerCase()}`}
                        ...
                        <div className="text-xs text-zinc-500">{t.rarity} pop.</div>
