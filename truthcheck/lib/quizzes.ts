...
export const quizzes: Quiz[] = [
  ...
  // ─── QUIZ 7 : MON EX ──────────────────────────────────────────────────────
  {
    ...
    gradientTo: 'to-cyan-950/80',
    borderColor: 'border-blue-800/30',
    accentColor: '#3b82f6',
    questions: [
      { text: 'Ton ex te contacte-t-il/elle de façon régulière sans raison particulière ?', options: [{ text: 'Non, nous n\'avons plus de contact', score: 0 }, { text: 'De temps en temps pour des raisons pratiques', score: 1 }, { text: 'Régulièrement avec des prétextes variés', score: 2 }, { text: 'Très souvent, parfois pour un rien', score: 3 }] },
      { text: 'Est-ce que ton ex like ou commente tes publications sur les réseaux sociaux ?', options: [{ text: 'Non, aucune interaction', score: 0 }, { text: 'Rarement, et de façon neutre', score: 1 }, { text: 'Souvent, surtout sur tes photos', score: 2 }, { text: 'Systématiquement, et parfois de façon très appuyée', score: 3 }] },
      { text: 'Ton ex t\'a-t-il/elle recontacté(e) après une longue période de silence ?', options: [{ text: 'Non, le silence est total', score: 0 }, { text: 'Un message unique après un moment', score: 1 }, { text: 'Oui, et les échanges ont repris doucement', score: 2 }, { text: 'Oui, de façon soudaine et insistante', score: 3 }] },
      { text: 'Est-ce que ton ex pose des questions sur ta vie sentimentale actuelle ?', options: [{ text: 'Non, jamais', score: 0 }, { text: 'Une fois, de façon anodine', score: 1 }, { text: 'Plusieurs fois, avec un intérêt marqué', score: 2 }, { text: 'Souvent, il/elle semble obsédé(e) par savoir si tu es avec quelqu\'un', score: 3 }] },
      { text: 'Ton ex t\'a-t-il/elle avoué regretter la rupture ?', options: [{ text: 'Non, pas du tout', score: 0 }, { text: 'Une allusion vague une fois', score: 1 }, { text: 'A reconnu clairement que la rupture était une erreur', score: 2 }, { text: 'Oui, plusieurs fois et de façon très directe', score: 3 }] },
      { text: 'Est-ce que ton ex parle de vous au passé avec nostalgie ?', options: [{ text: 'Non, il/elle ne mentionne jamais le passé', score: 0 }, { text: 'Parfois un bon souvenir sans y attacher d\'importance', score: 1 }, { text: 'Souvent avec une émotion visible', score: 2 }, { text: 'Toujours, il/elle semble idéaliser ce que vous aviez', score: 3 }] },
      { text: 'Est-ce que ton ex réagit si tu parles d\'une autre personne qui t\'intéresse ?', options: [{ text: 'Non, ça lui est égal', score: 0 }, { text: 'Une légère réaction imperceptible', score: 1 }, { text: 'Une réaction visible : tension, questions', score: 2 }, { text: 'Il/elle exprime clairement de la jalousie', score: 3 }] },
      { text: 'Ton ex essaie-t-il/elle de te rendre jaloux/jalouse en parlant d\'autres personnes ?', options: [{ text: 'Non, il/elle ne me parle pas de sa vie amoureuse', score: 0 }, { text: 'Il/Elle a mentionné quelqu\'un une fois de façon neutre', score: 1 }, { text: 'Parfois des allusions qui semblent calculées', score: 2 }, { text: 'Clairement, il/elle met en avant de nouvelles fréquentations devant moi', score: 3 }] },
      { text: 'Ton ex garde-t-il/elle des objets qui t\'appartiennent sans les rendre ?', options: [{ text: 'Non, tout a été rendu ou ça n\'existait pas', score: 0 }, { text: 'Quelques affaires oubliées sans intention claire', score: 1 }, { text: 'Garde certains objets en prétextant de te les rendre "bientôt"', score: 2 }, { text: 'Garde tout délibérément comme prétexte pour rester en contact', score: 3 }] },
      { text: 'Ton ex te parle-t-il/elle de ses problèmes et cherche-t-il/elle ton soutien ?', options: [{ text: 'Non, pas du tout', score: 0 }, { text: 'Parfois pour des choses pratiques', score: 1 }, { text: 'Souvent, il/elle compte sur moi émotionnellement', score: 2 }, { text: 'Très souvent, comme si j\'étais encore son/sa partenaire', score: 3 }] },
      { text: 'Est-ce que ton ex initie des moments en tête à tête ?', options: [{ text: 'Non, nous ne nous voyons pas', score: 0 }, { text: 'Des sorties de groupe avec des amis communs', score: 1 }, { text: 'Des situations seul(e) à seul(e) qui se présentent', score: 2 }, { text: 'Il/Elle organise clairement des occasions de vous retrouver seuls', score: 3 }] },
      { text: 'Ton ex cherche-t-il/elle physiquement la proximité (contact, regards) lors de vos rencontres ?', options: [{ text: 'Non, maintient des distances', score: 0 }, { text: 'La normalité du passé sans excès', score: 1 }, { text: 'Plus de contact physique que la situation ne l\'exige', score: 2 }, { text: 'Cherche clairement le contact et les regards prolongés', score: 3 }] },
      { text: 'Ton ex t\'envoie-t-il/elle des messages tard le soir ou tôt le matin ?', options: [{ text: 'Non, jamais', score: 0 }, { text: 'Rarement, pour des raisons précises', score: 1 }, { text: 'Parfois sans vraiment de raison claire', score: 2 }, { text: 'Souvent, avec des messages nostalgiques ou intimes', score: 3 }] },
      { text: 'Ton ex suit-il/elle activement tes stories sur Instagram/Snapchat ?', options: [{ text: 'Non, ou nous ne sommes plus amis', score: 0 }, { text: 'Les voit mais n\'interagit pas', score: 1 }, { text: 'Réagit souvent par un emoji ou une réponse', score: 2 }, { text: 'Toujours en premier à regarder et répond souvent', score: 3 }] },
      { text: 'Ton ex a-t-il/elle fait des gestes qui dépassent le cadre de l\'amitié ?', options: [{ text: 'Non, le cadre est clair', score: 0 }, { text: 'Un geste ambigu mais pas clair', score: 1 }, { text: 'Plusieurs gestes qui m\'ont interpellé(e)', score: 2 }, { text: 'Des gestes clairement romantiques ou affectueux', score: 3 }] },
      { text: 'Ton ex t\'a-t-il/elle dit qu\'il/elle t\'aime encore ?', options: [{ text: 'Non, jamais depuis la rupture', score: 0 }, { text: 'Un "je tiens à toi" sans préciser', score: 1 }, { text: 'Des aveux partiels ou implicites', score: 2 }, { text: 'Oui, clairement et plusieurs fois', score: 3 }] },
      { text: 'Est-ce que ton ex essaie de montrer qu\'il/elle a changé ?', options: [{ text: 'Non, aucune mention', score: 0 }, { text: 'Une légère évolution naturelle', score: 1 }, { text: 'Met en avant ses efforts de façon visible', score: 2 }, { text: 'Insiste sur ses changements comme pour te convaincre', score: 3 }] },
      { text: 'Ton ex réagit-il/elle quand tu prends de la distance ou ne réponds pas ?', options: [{ text: 'Non, respecte mon absence', score: 0 }, { text: 'Relance une fois de façon normale', score: 1 }, { text: 'Envoie plusieurs messages ou s\'inquiète', score: 2 }, { text: 'Réagit fortement, avec insistance ou reproches', score: 3 }] },
      { text: 'Ton ex évite-t-il/elle de confirmer une nouvelle relation officielle ?', options: [{ text: 'Il/elle est avec quelqu\'un et l\'assume', score: 0 }, { text: 'Seul(e) depuis la rupture sans explication', score: 1 }, { text: 'Vague sur sa vie sentimentale actuelle', score: 2 }, { text: 'Refuse de confirmer ou d\'infirmer une nouvelle relation', score: 3 }] },
      { text: 'Ton ex t\'invite-t-il/elle à des événements où il/elle sait que tu viendras ?', options: [{ text: 'Non, nous évoluons dans des cercles séparés', score: 0 }, { text: 'Des événements communs inévitables', score: 1 }, { text: 'Semble orchestrer des situations où nous nous croisons', score: 2 }, { text: 'Clairement cherche à être présent(e) dans mes sorties', score: 3 }] },
      { text: 'Depuis la rupture, ton ex s\'est-il/elle amélioré(e) dans les domaines qui étaient sources de conflits ?', options: [{ text: 'Non, ou je n\'en sais rien', score: 0 }, { text: 'Peut-être légèrement mais je ne sais pas si c\'est lié', score: 1 }, { text: 'Oui, et il/elle me l\'a fait savoir', score: 2 }, { text: 'Oui, clairement et il/elle insiste pour me le montrer', score: 3 }] },
      { text: 'Ton ex te rappelle-t-il/elle des moments spéciaux passés ensemble ?', options: [{ text: 'Non, le passé n\'est pas évoqué', score: 0 }, { text: 'Un souvenir lointain mentionné par hasard', score: 1 }, { text: 'Souvent avec émotion et détails précis', score: 2 }, { text: 'Régulièrement, comme pour reconstruire un pont émotionnel', score: 3 }] },
      { text: 'Ton ex t\'a-t-il/elle demandé si tu regrettais la rupture ?', options: [{ text: 'Non, jamais', score: 0 }, { text: 'Très indirectement une fois', score: 1 }, { text: 'Plusieurs fois, avec un espoir visible', score: 2 }, { text: 'Oui clairement et régulièrement', score: 3 }] },
      { text: 'Ton ex parle-t-il/elle encore de toi positivement à vos amis communs ?', options: [{ text: 'Non, ou je n\'en sais rien', score: 0 }, { text: 'Neutre, ni positif ni négatif', score: 1 }, { text: 'On m\'a dit qu\'il/elle parle bien de toi', score: 2 }, { text: 'Très positivement, voire en t\'idéalisant', score: 3 }] },
      { text: 'Dans l\'ensemble, as-tu l\'instinct que ton ex n\'a pas tourné la page ?', options: [{ text: 'Non, je pense qu\'il/elle a avancé', score: 0 }, { text: 'Peut-être encore quelques sentiments résiduels', score: 1 }, { text: 'Oui, plusieurs signaux me le font penser', score: 2 }, { text: 'Oui, j\'en suis convaincu(e)', score: 3 }] },
    ],
    resultTiers: [
      { min: 0, max: 20, emoji: '🚪', title: 'Passage à autre chose', message: 'Les signaux indiquent que ton ex a probablement tourné la page. L\'absence de contact et d\'intérêt romantique suggère qu\'il/elle avance. Le mieux est de faire pareil.', color: 'text-zinc-400', glowColor: '#a1a1aa' },
      { min: 20, max: 40, emoji: '🤷', title: 'Ambivalent(e)', message: 'Les signaux sont mixtes. Ton ex garde peut-être un attachement résiduel mais sans plan clair. Il est difficile de savoir avec certitude ses intentions réelles.', color: 'text-yellow-400', glowColor: '#facc15' },
      { min: 40, max: 60, emoji: '💭', title: 'Nostalgique', message: 'Plusieurs signes montrent que ton ex pense encore à toi et garde un attachement émotionnel. Il/elle n\'a peut-être pas encore clairement décidé ce qu\'il/elle veut.', color: 'text-blue-400', glowColor: '#60a5fa' },
      { min: 60, max: 80, emoji: '💌', title: 'Envie de renouer', message: 'Les signaux sont nombreux et cohérents : ton ex cherche à maintenir le lien et montre des signes clairs de vouloir se rapprocher. Une conversation honnête pourrait clarifier les choses.', color: 'text-violet-400', glowColor: '#a78bfa' },
      { min: 80, max: 101, emoji: '🔥', title: 'Veut clairement revenir', message: 'Les indices sont très forts. Ton ex multiplie les signaux qui indiquent une envie de retour. C\'est à toi de décider si c\'est ce que tu veux aussi.', color: 'text-pink-400', glowColor: '#f472b6' },
    ],
  },
  // ─── QUIZ 8 : MANIPULÉ(E) ─────────────────────────────────────────────────
  {
  ...
  // ─── QUIZ 12 : CRUSH ──────────────────────────────────────────────────────
  {
    ...
    accentColor: '#ec4899',
    questions: [
      { text: 'Est-ce que ton crush cherche à se retrouver dans le même endroit que toi ?', options: [{ text: 'Non, c\'est toujours le hasard', score: 0 }, { text: 'Parfois, mais ça peut être une coïncidence', score: 1 }, { text: 'Souvent, il/elle semble prévoir d\'être là où je suis', score: 2 }, { text: 'Toujours, il/elle organise clairement des occasions', score: 3 }] },
      { text: 'Est-ce que ton crush maintient un contact visuel prolongé avec toi ?', options: [{ text: 'Non, il/elle évite mon regard', score: 0 }, { text: 'Un regard normal, ni plus ni moins', score: 1 }, { text: 'Souvent un regard appuyé qui me déstabilise', score: 2 }, { text: 'Toujours, ses yeux reviennent constamment vers moi', score: 3 }] },
      { text: 'Est-ce que ton crush te sourit d\'une façon qui semble différente de ses sourires habituels ?', options: [{ text: 'Non, même sourire pour tout le monde', score: 0 }, { text: 'Peut-être légèrement différent', score: 1 }, { text: 'Oui, un sourire plus sincère ou timide avec moi', score: 2 }, { text: 'Clairement, il/elle rayonne différemment quand on se regarde', score: 3 }] },
      { text: 'Est-ce que ton crush trouve des excuses pour te toucher (bras, épaule) ?', options: [{ text: 'Non, aucun contact physique', score: 0 }, { text: 'Un contact normal et anodin', score: 1 }, { text: 'Des contacts qui semblent intentionnels', score: 2 }, { text: 'Oui, cherche clairement la proximité physique', score: 3 }] },
      { text: 'Est-ce que ton crush se souvient de petits détails que tu as mentionnés ?', options: [{ text: 'Non, il/elle semble ne pas écouter attentivement', score: 0 }, { text: 'Se souvient des choses importantes', score: 1 }, { text: 'Souvent il/elle cite des choses que j\'ai dites bien avant', score: 2 }, { text: 'Toujours, même des détails insignifiants', score: 3 }] },
      { text: 'Est-ce que ton crush devient nerveux/nerveuse ou différent(e) autour de toi ?', options: [{ text: 'Non, totalement à l\'aise', score: 0 }, { text: 'Légèrement mais rien de notable', score: 1 }, { text: 'Parfois maladroit(e) ou rougit avec moi', score: 2 }, { text: 'Clairement, il/elle change de comportement en ma présence', score: 3 }] },
      { text: 'Est-ce que ton crush te répond rapidement quand tu lui envoies un message ?', options: [{ text: 'Non, les réponses sont lentes ou rares', score: 0 }, { text: 'Dans un délai normal', score: 1 }, { text: 'Souvent très vite, presque instantanément', score: 2 }, { text: 'Toujours en quelques minutes même la nuit', score: 3 }] },
      { text: 'Est-ce que ton crush initie des conversations avec toi ?', options: [{ text: 'Non, c\'est toujours moi qui commence', score: 0 }, { text: 'Parfois de son côté aussi', score: 1 }, { text: 'Souvent, il/elle trouve des prétextes pour parler', score: 2 }, { text: 'Toujours, il/elle est le/la premier(e) à écrire', score: 3 }] },
      { text: 'Est-ce que ton crush te taquine d\'une façon qui semble affectueuse ?', options: [{ text: 'Non, interactions normales', score: 0 }, { text: 'Quelques taquineries neutres', score: 1 }, { text: 'Des taquineries avec une douceur particulière', score: 2 }, { text: 'Souvent, il/elle te taquine en cherchant ta réaction', score: 3 }] },
      { text: 'Est-ce que ton crush te traite différemment des autres autour de lui/elle ?', options: [{ text: 'Non, même attitude avec tout le monde', score: 0 }, { text: 'Peut-être légèrement', score: 1 }, { text: 'Oui, il/elle est plus attentif/attentive avec moi', score: 2 }, { text: 'Clairement, je reçois un traitement de faveur', score: 3 }] },
      { text: 'Est-ce que ton crush like systématiquement tes publications sur les réseaux ?', options: [{ text: 'Non, aucune interaction', score: 0 }, { text: 'Parfois, comme il/elle le fait avec tout le monde', score: 1 }, { text: 'Souvent, et réagit aussi aux stories', score: 2 }, { text: 'Toujours, premier(e) à réagir', score: 3 }] },
      { text: 'Est-ce que ton crush te complimente régulièrement ?', options: [{ text: 'Non, jamais', score: 0 }, { text: 'De temps en temps de façon neutre', score: 1 }, { text: 'Souvent avec des compliments sincères', score: 2 }, { text: 'Très souvent, de façon appuyée', score: 3 }] },
      { text: 'Est-ce que ton crush pose des questions sur ta vie personnelle ou sentimentale ?', options: [{ text: 'Non, conversations superficielles', score: 0 }, { text: 'Parfois par curiosité normale', score: 1 }, { text: 'Souvent, notamment sur ma vie amoureuse', score: 2 }, { text: 'Régulièrement, avec un intérêt marqué pour ma situation', score: 3 }] },
      { text: 'Est-ce que ton crush te défend ou prend ton parti face aux autres ?', options: [{ text: 'Non, reste neutre', score: 0 }, { text: 'Parfois si la situation l\'exige', score: 1 }, { text: 'Souvent prend ton parti naturellement', score: 2 }, { text: 'Toujours, parfois même de façon prononcée', score: 3 }] },
      { text: 'Est-ce que ton crush imite inconsciemment tes gestes ou postures ?', options: [{ text: 'Je n\'ai pas remarqué', score: 0 }, { text: 'Peut-être parfois', score: 1 }, { text: 'Souvent, nos postures semblent se répondre', score: 2 }, { text: 'Oui, c\'est flagrant et constant', score: 3 }] },
      { text: 'Est-ce que des amis communs suggèrent ou plaisantent sur une attraction entre vous ?', options: [{ text: 'Non, personne ne le mentionne', score: 0 }, { text: 'Une remarque isolée', score: 1 }, { text: 'Plusieurs personnes l\'ont suggéré', score: 2 }, { text: 'Tout le groupe semble voir quelque chose', score: 3 }] },
      { text: 'Est-ce que ton crush semble jaloux/jalouse quand tu parles d\'autres personnes ?', options: [{ text: 'Non, totalement indifférent(e)', score: 0 }, { text: 'Peut-être un très légère réaction', score: 1 }, { text: 'Une réaction visible quand je parle de quelqu\'un', score: 2 }, { text: 'Clairement, une réaction jalouse ou defensive', score: 3 }] },
      { text: 'Est-ce que ton crush cherche ton attention dans un groupe ?', options: [{ text: 'Non, s\'adresse à tout le monde pareil', score: 0 }, { text: 'Parfois s\'assure que j\'entends ses histoires', score: 1 }, { text: 'Souvent, me regarde pour avoir ma réaction', score: 2 }, { text: 'Clairement, me prend souvent comme interlocuteur/interlocutrice principal(e)', score: 3 }] },
      { text: 'Est-ce que les conversations avec ton crush durent longtemps naturellement ?', options: [{ text: 'Non, conversations courtes', score: 0 }, { text: 'Durée normale', score: 1 }, { text: 'Souvent longues et naturelles', score: 2 }, { text: 'Toujours, les heures passent sans qu\'on s\'en rende compte', score: 3 }] },
      { text: 'Est-ce que ton crush prend soin de son apparence avant de te voir ?', options: [{ text: 'Je ne peux pas le savoir', score: 0 }, { text: 'Il/elle est toujours présentable normalement', score: 1 }, { text: 'On m\'a dit qu\'il/elle prépare sa tenue quand il sait qu\'il me verra', score: 2 }, { text: 'Clairement plus soigné(e) lors de nos rencontres', score: 3 }] },
      { text: 'Est-ce que ton crush t\'a déjà fait un geste ou un cadeau inattendu ?', options: [{ text: 'Non, jamais', score: 0 }, { text: 'Un geste sympathique normal', score: 1 }, { text: 'Un geste qui m\'a particulièrement touché(e)', score: 2 }, { text: 'Oui, des attentions qui semblent clairement romantiques', score: 3 }] },
      { text: 'Est-ce que ton crush partage ses préoccupations ou secrets avec toi ?', options: [{ text: 'Non, relation superficielle', score: 0 }, { text: 'Des sujets normaux', score: 1 }, { text: 'Souvent des choses personnelles', score: 2 }, { text: 'Me confie des choses qu\'il/elle ne dit pas aux autres', score: 3 }] },
      { text: 'Est-ce que ton instinct te dit que ton crush a des sentiments pour toi ?', options: [{ text: 'Non, je ne ressens rien', score: 0 }, { text: 'Peut-être, une légère intuition', score: 1 }, { text: 'Souvent j\'ai le sentiment qu\'il y a quelque chose', score: 2 }, { text: 'Oui, je le sens fortement', score: 3 }] },
      { text: 'Dans l\'ensemble, combien de signaux positifs as-tu identifié ?', options: [{ text: 'Très peu ou aucun', score: 0 }, { text: 'Quelques-uns mais ambigus', score: 1 }, { text: 'Plusieurs signaux clairs', score: 2 }, { text: 'De nombreux signaux forts et cohérents', score: 3 }] },
    ],
    resultTiers: [
      { min: 0, max: 20, emoji: '😶', title: 'Rien de romantique', message: 'Les signaux indiquent que ton crush te voit probablement comme un(e) ami(e). Il n\'est pas impossible que les choses évoluent, mais pour l\'instant, l\'attirance romantique semble absente.', color: 'text-zinc-400', glowColor: '#a1a1aa' },
      { min: 20, max: 40, emoji: '🤔', title: 'Légère attirance possible', message: 'Quelques signaux positifs mais rien de définitif. Il peut y avoir un intérêt naissant. Continue à observer et à approfondir vos échanges.', color: 'text-yellow-400', glowColor: '#facc15' },
      { min: 40, max: 60, emoji: '💛', title: 'Peut-être intéressé(e)', message: 'Plusieurs signes suggèrent un intérêt de sa part. Il/elle te remarque et te traite spécialement. Courage pour te rapprocher et créer plus d\'occasions de vous voir.', color: 'text-amber-400', glowColor: '#fbbf24' },
      { min: 60, max: 80, emoji: '💗', title: 'Signes prometteurs', message: 'Les signaux sont nombreux et cohérents. Il y a très probablement une attirance de sa part. Le moment est peut-être venu de montrer que tu es intéressé(e) aussi.', color: 'text-pink-400', glowColor: '#f472b6' },
      { min: 80, max: 101, emoji: '💘', title: 'Clairement intéressé(e)', message: 'Les signaux sont très forts et convergent vers une attirance romantique réelle. Il/elle ressent probablement quelque chose pour toi. Ose franchir le pas !', color: 'text-red-400', glowColor: '#f87171' },
    ],
  },
  // ─── QUIZ 13 : BURNOUT ────────────────────────────────────────────────────
  {
